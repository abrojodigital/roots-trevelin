    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="/alumnos/<?= $alumno['id'] ?>" data-validate>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" 
                                       required value="<?= htmlspecialchars($alumno['nombre']) ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="apellido" name="apellido" 
                                       required value="<?= htmlspecialchars($alumno['apellido']) ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="edad" name="edad" 
                                       min="3" max="18" value="<?= htmlspecialchars($alumno['edad']) ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="usuario_id" name="usuario_id" required>
                                    ...
                                    <?php foreach ($usuarios as $usuario): ?>
                                        <option value="<?= $usuario['id'] ?>" 
                                                <?= $alumno['usuario_id'] == $usuario['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="observaciones" name="observaciones" rows="3"
                                  placeholder="Información adicional sobre el alumno"><?= htmlspecialchars($alumno['observaciones']) ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <?php 
                            $cursosAsignadosIds = array_column($cursosAsignados, 'id');
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               id="curso_<?= $curso['id'] ?>"
                                               <?= in_array($curso['id'], $cursosAsignadosIds) ? 'checked' : '' ?>>
